...
/****** Object:  View [dbo].[Vista_Detalle_Pedido_ABM]    Script Date: 02/01/2017 22:12:59 ******/
SET ANSI_NULLS ON
GO
...
SELECT     dbo.DetallePedidos.IdArticulo, dbo.DetallePedidos.Codigo_Articulo AS CodigoArticulo, dbo.DetallePedidos.Cantidad, dbo.DetallePedidos.Descripcion AS Articulo, 
                      dbo.Productos.IdProducto AS IdPropio, 'PRODUCTOS' AS Tabla, dbo.DetallePedidos.PrecioUnitario AS Precio, dbo.Articulos.PorcentajeIva AS IVA, 
                      ...
                      dbo.CoeficientesArticulos.CoeficienteRevendedor AS Rev, dbo.DetallePedidos.IdDetallePedido, dbo.DetallePedidos.IdPedido

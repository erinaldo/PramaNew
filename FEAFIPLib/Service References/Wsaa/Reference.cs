...
namespace FEAFIPLib.Wsaa {
    ...
    public interface LoginCMS {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(FEAFIPLib.Wsaa.LoginFault), Action="", Name="fault")]
        FEAFIPLib.Wsaa.loginCmsResponse loginCms(FEAFIPLib.Wsaa.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LoginCMSChannel : FEAFIPLib.Wsaa.LoginCMS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<FEAFIPLib.Wsaa.LoginCMS>, FEAFIPLib.Wsaa.LoginCMS {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        FEAFIPLib.Wsaa.loginCmsResponse FEAFIPLib.Wsaa.LoginCMS.loginCms(FEAFIPLib.Wsaa.loginCmsRequest request) {
            return base.Channel.loginCms(request);
        }
        
        public string loginCms(string in0) {
            FEAFIPLib.Wsaa.loginCmsRequest inValue = new FEAFIPLib.Wsaa.loginCmsRequest();
            inValue.in0 = in0;
            FEAFIPLib.Wsaa.loginCmsResponse retVal = ((FEAFIPLib.Wsaa.LoginCMS)(this)).loginCms(inValue);

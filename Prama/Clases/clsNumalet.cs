...
/// </summary>
public sealed class clsNumalet
{
    ...
    public clsNumalet(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
    {
    ...
    {
        return clsNumalet.ToCardinal(Numero, CultureInfo.CurrentCulture);
    }
